            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="/students" class="waves-effect"><i class="fa fa-fw material-icons" aria-hidden="true">home</i>Home</a>
                    </li>
                    <li style="">
                        <a href="/student/materi" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">menu_book</i>Materi</a>
                    </li>
                    <li style="">
                        <a href="/student/tugas" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">work</i>Tugas</a>
                    </li>
                    <li style="">
