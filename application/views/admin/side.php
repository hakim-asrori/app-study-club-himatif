            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="/admins" class="waves-effect"><i class="fa fa-fw material-icons" aria-hidden="true">home</i>Home</a>
                    </li>
                    <li style="">
                        <a href="/admin/kelas" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">class</i>Kelas</a>
                    </li>
                    <li style="">
                        <a href="/admin/lecturer" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">supervisor_account</i>Pemateri</a>
                    </li>
                    <li style="">
                        <a href="/admin/mahasiswa" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">people</i>Mahasiswa</a>
                    </li>
                    <li style="">
                        <a href="/admin/study" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">library_books</i>Bidang Study</a>
                    </li>
                    <li style="">
                        <a href="/admin/materi" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">dns</i>List Materi</a>
                    </li>
                    <li style="">
                        <a href="/admin/tugas" class="waves-effect "><i class="fa fa-fw material-icons" aria-hidden="true">view_list</i>List Tugas</a>
                    </li>
                    <li style="">
